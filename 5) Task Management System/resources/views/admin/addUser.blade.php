                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            ...
                            <h5 class="panel-title" align="center"><u>Add New Usere</u></h5>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label>Email :</label>
                                <input type="email" class="form-control" required name="email" placeholder="Please Enter Email">
                            </div>

                            <div class="form-group">
                                <label>Password :</label>
                                <input type="text" class="form-control" required name="password" placeholder="Please Enter Email">
                            </div>
