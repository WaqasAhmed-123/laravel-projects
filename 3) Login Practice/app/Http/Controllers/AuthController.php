...
class AuthController extends Controller
{
    ...
    public function postUpdateProfile(Request $request)
    {
        ...
        $updateUser = User::where('id', $id)->update(['name' => $name, 'contact' => $contact, 'email' => $email, 'updated_at' => date('Y-m-d H:i:s')]);
    ...
    public function postUpdatePassword(Request $request)
    {
        ...
        if ($validator->fails()) 
        {
            return redirect()->back()->with('error', 'Somethings wrong with Password and Confirm Password.');   
        }
